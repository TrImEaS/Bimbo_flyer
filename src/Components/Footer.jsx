        ...
        <section className="flex flex-col justify-center w-full gap-3">
          ...
          <article className="flex items-center max-w-[400px] w-full gap-2 p-4 rounded-lg shadow-lg border-2 duration-300 hover:scale-105">
            ...
            <div className="flex-1 flex flex-wrap gap-x-3">
              ...
              <a target="_blank" href="https://wa.me/+5491126180413?text=Hola me comunico desde la pagina de OutletGolosinas." className="text-xl">11-2618-0413</a>
              <span className="max-md:hidden">/</span>
              <a target="_blank" href="https://wa.me/+5491157092539?text=Hola me comunico desde la pagina de OutletGolosinas." className="text-xl">11-5709-2539</a>
            </div>
          </article>
        </section>
      </div>
