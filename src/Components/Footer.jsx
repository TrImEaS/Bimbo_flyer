  ...
  const handleSubmit = (e) => {
    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch('http://31.97.250.187/outletgolosinas/admin_flyer/admin_page/admin_mail.php', {
          method: 'POST',
          headers: {
      ...
      <div className="flex gap-3 z-10 max-[780px]:flex-col">
        ...
        <section className="flex flex-col w-full gap-3 max-[785px]:hidden">
          ...
          <a target="_blank" href="https://www.google.com/maps/place/Federico+Lacroze+4171,+C1427+EDG,+Cdad.+Aut%C3%B3noma+de+Buenos+Aires/@-34.5864206,-58.4576819,17z/data=!3m1!4b1!4m6!3m5!1s0x95bcb5e4f9e7f8c1:0xd5e95eec4a2db45!8m2!3d-34.586425!4d-58.455107!16s%2Fg%2F11c2gxsbvc?entry=ttu&g_ep=EgoyMDI0MDgyNi4wIKXMDSoASAFQAw%3D%3D" className="flex hover:scale-105 duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            <div className="flex-1">
              <h2 className="text-lg font-bold text-white">FEDERICO LACROZE 4171, CHACARITA</h2>
            </div>
          </a>
        ...
        <section className="flex flex-col w-full gap-3 max-[785px]:hidden">
          <a target="_blank" href="https://wa.me/+5491157999632?text=Hola me comunico desde la pagina de OutletGolosinas." className="flex duration-300 hover:scale-105 items-center max-w-[400px] w-full gap-2 p-4 rounded-lg shadow-lg border-2">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-bold">GREGORIO DE LAFERRERE</h2>
          ...
          <a target="_blank" href="https://wa.me/+5491157092539?text=Hola me comunico desde la pagina de OutletGolosinas." className="flex duration-300 hover:scale-105 items-center max-w-[400px] w-full gap-2 p-4 rounded-lg shadow-lg border-2">
            <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            <div className="flex-1">
              <h2 className="text-lg font-bold">CHACARITA</h2>
              <p className="text-xl">11-5809-7645</p>
            </div>
          </a>

          <a target="_blank" href="https://wa.me/+5491155027692?text=Hola me comunico desde la pagina de OutletGolosinas." className="flex duration-300 hover:scale-105 items-center max-w-[400px] w-full gap-2 p-4 rounded-lg shadow-lg border-2">
            <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            <div className="flex-1">
              <h2 className="text-lg font-bold">ISIDRO CASANOVA</h2>
        ...
        {/*Mobile location/wpp */}
        <section className="flex flex-col w-full gap-3 min-[785px]:hidden">
          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Piedra+Buena+6059,+B1757BRU+Gregorio+de+Laferrere,+Provincia+de+Buenos+Aires/@-34.7479216,-58.5855061,17z/data=!4m6!3m5!1s0x95bcc5a4fefa92a9:0x99f7dbdacc71f017!8m2!3d-34.7479303!4d-58.585655!16s%2Fg%2F11fz963qk0?entry=ttu">
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
            ...
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://wa.me/+5491157999632?text=Hola me comunico desde la pagina de OutletGolosinas.">
              <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            </a>
          </div>

          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Victorino+de+la+Pl.+1095,+B1755ACU+Rafael+Castillo,+Provincia+de+Buenos+Aires/@-34.7002434,-58.6314094,17z/data=!3m1!4b1!4m6!3m5!1s0x95bcc6c3a62c3bb3:0x9554ebe49da62724!8m2!3d-34.7002479!4d-58.6265385!16s%2Fg%2F11h553td5f?entry=ttu">
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
          ...
          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Outlet+Panificados+%26+Golosinas/@-34.7134188,-58.4955985,20.75z/data=!4m14!1m7!3m6!1s0x95bcceddac97550b:0x7d8fff4e7986b7d9!2sBuenos+Aires+Central+Market!8m2!3d-34.7089502!4d-58.500517!16s%2Fg%2F120j3kz8!3m5!1s0x95bccf0be3a590ef:0x53f281e80b285e5f!8m2!3d-34.7133725!4d-58.4952592!16s%2Fg%2F11t29q39g4?entry=ttu">
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
            ...
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://wa.me/+5491126180413?text=Hola me comunico desde la pagina de OutletGolosinas.">
              <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            </a>
          </div>
          ...
          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Federico+Lacroze+4171,+C1427+EDG,+Cdad.+Aut%C3%B3noma+de+Buenos+Aires/@-34.5864206,-58.4576819,17z/data=!3m1!4b1!4m6!3m5!1s0x95bcb5e4f9e7f8c1:0xd5e95eec4a2db45!8m2!3d-34.586425!4d-58.455107!16s%2Fg%2F11c2gxsbvc?entry=ttu&g_ep=EgoyMDI0MDgyNi4wIKXMDSoASAFQAw%3D%3D" >
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
            ...
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://wa.me/+5491158097645?text=Hola me comunico desde la pagina de OutletGolosinas.">
              <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            </a>
          </div>

          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Guillermo+Marconi+3496,+B1765LEL+Isidro+Casanova,+Provincia+de+Buenos+Aires/@-34.7125326,-58.5959213,17z/data=!3m1!4b1!4m5!3m4!1s0x95bcc67bf13fa3b7:0xcb6e74c8058a287!8m2!3d-34.712537!4d-58.5933464?entry=ttu" >
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
            ...
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://wa.me/+5491155027692?text=Hola me comunico desde la pagina de OutletGolosinas.">
              <FaWhatsapp className="text-green-500 text-5xl font-bold"/>
            </a>
          </div>
          
          <div className="flex duration-300 items-center max-w-[400px] w-full p-4 rounded-lg shadow-lg border-2 gap-2">
            <a className="hover:scale-110 duration-300 flex-0" target="_blank" href="https://www.google.com/maps/place/Rojas+127,+C1405AAC+Cdad.+Aut%C3%B3noma+de+Buenos+Aires/@-34.6188714,-58.4445689,17z/data=!3m1!4b1!4m6!3m5!1s0x95bcca3f392e7c1f:0x60c547b136cdc8dd!8m2!3d-34.6188714!4d-58.441994!16s%2Fg%2F11bw44crth?entry=ttu&g_ep=EgoyMDI0MDgyMC4xIKXMDSoASAFQAw%3D%3D" >
              <img aria-hidden="true" alt="location icon" src={mobile_icon} className="w-14 h-14" />
            </a>
